...
const hant = {
  ...
  // The gap between letting go and the question appearing: the recording is being transcribed,
  // which takes a second or two. Without a state of its own the bar looks idle while it works.
  "bar.sending": "送緊…",
  "bar.sendingSub": "· 等我聽清楚",
  ...
  // 跟進 speaks, and remembers the conversation (components/track/followup.ts).
  "track.visitIn": "{n} 日之後覆診",
  "track.tapWhenTaken": "食咗就撳一下",
  "track.stop": "。",
  "track.recapTitle": "我哋講咗嘅",
  "track.recapDone": "張紙上面嘅嘢，講晒喇。",
  "track.recapProgress": "講咗 {n} 段，仲未講完。",
  "track.recapCounts": "你話明白 {understood} 次 · 叫我再講 {repeated} 次 · 問咗 {asked} 個問題",
  "track.recapContinue": "繼續傾",
  "share.button": "分享俾屋企人",
  ...
  "share.summaryTitle": "概要",
  "share.summary": "呢張紙有{parts}。",
  "share.summaryVisit": "下次覆診 {date}。",
  "share.notes": "要注意",
  "share.stoppedLine": "張紙寫唔使再食：{name}",
  "share.contactLine": "醫院電話：{text}",
...
const hans: Record<UiKey, string> = {
  ...
  "track.visitIn": "{n} 天之后复诊",
  "track.tapWhenTaken": "吃了就按一下",
  "track.stop": "。",
  "track.recapTitle": "我们讲过的",
  "track.recapDone": "纸上的内容，都讲完了。",
  "track.recapProgress": "讲了 {n} 段，还没讲完。",
  "track.recapCounts": "你说明白 {understood} 次 · 让我再讲 {repeated} 次 · 问了 {asked} 个问题",
  "track.recapContinue": "继续聊",
  "share.button": "分享给家人",
  ...
  "share.summaryTitle": "概要",
  "share.summary": "这张纸有{parts}。",
  "share.summaryVisit": "下次复诊 {date}。",
  "share.notes": "要注意",
  "share.stoppedLine": "纸上写不用再吃：{name}",
  "share.contactLine": "医院电话：{text}",
...
const en: Record<UiKey, string> = {
  ...
  "bar.sending": "Sending…",
  "bar.sendingSub": "· getting that right",
  ...
  "track.visitIn": "Next visit in {n} days",
  "track.tapWhenTaken": "Tap when you've taken one",
  "track.stop": ".",
  "track.recapTitle": "What we went through",
  "track.recapDone": "Everything on the sheet has been covered.",
  "track.recapProgress": "{n} sections so far — not finished yet.",
  "track.recapCounts": "You said understood {understood} times · asked me to repeat {repeated} times · asked {asked} questions of your own",
  "track.recapContinue": "Carry on talking",
  ...
  "share.summaryTitle": "Summary",
  "share.summary": "The sheet lists {parts}.",
  "share.summaryVisit": "Next visit {date}.",
  "share.notes": "Things to note",
  "share.stoppedLine": "The sheet says this one has stopped: {name}",
  "share.contactLine": "Hospital contact: {text}",
